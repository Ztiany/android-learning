...
class AJXUtils {
    ...
    static boolean isExcludeFilterMatched(String str, List<String> filters) {
        def result = isFilterMatched(str, filters, FilterPolicy.EXCLUDE)
        println "AJXUtils.isExcludeFilterMatched str = $str, filters = $filters result = $result"
        return result
    }

    static boolean isIncludeFilterMatched(String str, List<String> filters) {
        def result = isFilterMatched(str, filters, FilterPolicy.INCLUDE)
        println "AJXUtils.isIncludeFilterMatched str = $str, filters = $filters result = $result"
        return result
    }
