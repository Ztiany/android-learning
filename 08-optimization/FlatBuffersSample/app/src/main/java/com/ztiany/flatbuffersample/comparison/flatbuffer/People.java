...
public final class People extends Table {
  ...
  public long index() { int o = __offset(6); return o != 0 ? bb.getLong(o + bb_pos) : 0L; }
  ...
  public Friend friends(Friend obj, int j) { int o = __offset(18); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  ...
  public static void addIndex(FlatBufferBuilder builder, long index) { builder.addLong(1, index, 0L); }
