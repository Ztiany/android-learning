...
void Java_com_ztiany_fmod_PlaySoundActivity_buttonDown(JNIEnv *env, jobject thiz, jint index) {
    gDownButtons |= (1 << index);
}

void Java_com_ztiany_fmod_PlaySoundActivity_buttonUp(JNIEnv *env, jobject thiz, jint index) {
    gDownButtons &= ~(1 << index);
}

void Java_com_ztiany_fmod_PlaySoundActivity_setStateCreate(JNIEnv *env, jobject thiz) {

}

void Java_com_ztiany_fmod_PlaySoundActivity_setStateStart(JNIEnv *env, jobject thiz) {
    gSuspendState = false;
}

void Java_com_ztiany_fmod_PlaySoundActivity_setStateStop(JNIEnv *env, jobject thiz) {
    gSuspendState = true;
}

void Java_com_ztiany_fmod_PlaySoundActivity_setStateDestroy(JNIEnv *env, jobject thiz) {
    gQuitState = true;
}

void Java_com_ztiany_fmod_PlaySoundActivity_main(JNIEnv *env, jobject thiz) {
    gJNIEnv = env;
