...
fun Int.printConnectionState(deviceInfo: String) {
    when (this) {
        BluetoothGatt.GATT_SUCCESS -> Timber.d("${deviceInfo}: BluetoothGatt.GATT_SUCCESS")
        BluetoothGatt.GATT_FAILURE -> Timber.d("${deviceInfo}: BluetoothGatt.GATT_FAILURE")
        BluetoothGatt.GATT_CONNECTION_CONGESTED -> Timber.d("${deviceInfo}: BluetoothGatt.GATT_CONNECTION_CONGESTED")
        BluetoothGatt.GATT_INSUFFICIENT_AUTHENTICATION -> Timber.d("${deviceInfo}: BluetoothGatt.GATT_INSUFFICIENT_AUTHENTICATION")
        BluetoothGatt.GATT_INSUFFICIENT_ENCRYPTION -> Timber.d("${deviceInfo}: BluetoothGatt.GATT_INSUFFICIENT_ENCRYPTION")
        BluetoothGatt.GATT_INVALID_OFFSET -> Timber.d("${deviceInfo}: BluetoothGatt.GATT_INVALID_OFFSET")
        BluetoothGatt.GATT_READ_NOT_PERMITTED -> Timber.d("${deviceInfo}: BluetoothGatt.GATT_READ_NOT_PERMITTED")
        BluetoothGatt.GATT_REQUEST_NOT_SUPPORTED -> Timber.d("${deviceInfo}: BluetoothGatt.GATT_REQUEST_NOT_SUPPORTED")
    }
}
