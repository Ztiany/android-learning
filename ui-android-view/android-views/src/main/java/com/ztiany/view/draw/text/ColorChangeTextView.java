...
public class ColorChangeTextView extends View {
    ...
    private void initAttr(final Context context, @Nullable final AttributeSet attrs) {
        ...
        mText = ta.getString(R.styleable.ColorChangeTextView_cctv_text);
        mTextSize = ta.getDimensionPixelSize(R.styleable.ColorChangeTextView_cctv_text_size, mTextSize);
        mTextColor = ta.getColor(R.styleable.ColorChangeTextView_cctv_text_color, mTextColor);
        mTextColorChange = ta.getColor(R.styleable.ColorChangeTextView_cctv_text_color_change, mTextColorChange);
        mProgress = ta.getFloat(R.styleable.ColorChangeTextView_cctv_progress, 0);
        mDirection = ta.getInt(R.styleable.ColorChangeTextView_cctv_direction, mDirection);
        ta.recycle();
    ...
    protected void onDraw(final Canvas canvas) {
        ...
        switch (mDirection) {
            ...
            case DIRECTION_RIGHT:
                ...
                drawTextHorizontal(canvas, mTextColorChange, (int) (mTextStartX + (1 - mProgress) * mTextWidth), mTextStartX + mTextWidth);
                //后绘制没改变的
                drawTextHorizontal(canvas, mTextColor, mTextStartX, (int) (mTextStartX + (1 - mProgress) * mTextWidth));
                break;
            case DIRECTION_TOP:
                Log.i(TAG, "DIRECTION_TOP = " + DIRECTION_TOP);
                //先绘制改变的颜色
                drawTextVertical(canvas, mTextColorChange, mTextStartY, (int) (mTextStartY + mProgress * mTextHeight));
                //后绘制没改变的
                drawTextVertical(canvas, mTextColor, (int) (mTextStartY + mProgress * mTextHeight), mTextStartY + mTextHeight);
                break;
            case DIRECTION_BOTTOM:
                Log.i(TAG, "DIRECTION_BOTTOM = " + DIRECTION_BOTTOM);
                //先绘制改变的颜色
                drawTextVertical(canvas, mTextColorChange, (int) (mTextStartY + (1 - mProgress) * mTextHeight), mTextStartY + mTextHeight);
                //后绘制没改变的
                drawTextVertical(canvas, mTextColor, mTextStartY, (int) (mTextStartY + (1 - mProgress) * mTextHeight));
                break;
            default:
                break;
        }
