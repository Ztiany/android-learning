...
public class TextMeasureView extends View {
    ...
    private static final String TAG = "TextMeasureView";
...
//        public float top;
        Log.i(TAG, "mFontMetrics = {ascent: " + mFontMetrics.ascent + " ,bottom: " + mFontMetrics.bottom + " ,descent: " + mFontMetrics.descent + " ,leading: " + mFontMetrics.leading + " ,top: " + mFontMetrics.top);
    }
