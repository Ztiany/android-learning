...
public class PeachHeartsView extends View {
    ...
    public PeachHeartsView(Context context) {
        this(context, null);
    }

    public PeachHeartsView(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private void drawCoordinateSystem(Canvas canvas) {
        ...
        canvas.drawLine(0, -2000, 0, 2000, helpPaint);
        canvas.drawLine(-2000, 0, 2000, 0, helpPaint);
