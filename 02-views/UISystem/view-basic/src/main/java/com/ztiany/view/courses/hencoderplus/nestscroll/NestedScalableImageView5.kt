package com.ztiany.view.courses.hencoderplus.nestscroll
...
class NestedScalableImageView5 @JvmOverloads constructor(
    ...
    inner class HenGestureListener : GestureDetector.SimpleOnGestureListener() {
        ...
        override fun onFling(
            ...
            if (big) {
                ...
                ViewCompat.postOnAnimation(this@NestedScalableImageView5, henFlingRunner)
            }
            return false
        }
    ...
    inner class HenFlingRunner : Runnable {
        override fun run() {
            if (scroller.computeScrollOffset()) {
                ...
                invalidate()
                ViewCompat.postOnAnimation(this@NestedScalableImageView5, this)
            }
        }
    }
