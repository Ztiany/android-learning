...
public class ColorChangeTextView1 extends View {
    ...
    private void initAttr(final Context context, @Nullable final AttributeSet attrs) {
        ...
        mTextSize = ta.getDimensionPixelSize(R.styleable.ColorChangeTextView1_text_size, mTextSize);
        mTextColor = ta.getColor(R.styleable.ColorChangeTextView1_text_color, mTextColor);
        mTextColorChange = ta.getColor(R.styleable.ColorChangeTextView1_text_color_change, mTextColorChange);
        mProgress = ta.getFloat(R.styleable.ColorChangeTextView1_progress, 0);
        mDirection = ta.getInt(R.styleable.ColorChangeTextView1_direction, mDirection);
        ta.recycle();
