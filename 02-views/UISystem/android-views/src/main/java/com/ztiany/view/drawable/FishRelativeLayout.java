...
public class FishRelativeLayout extends RelativeLayout {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (PointF point : mPoints) {
            canvas.drawPoint(point.x, point.y, mPathPaint);
        }
    ...
    private void makeTrail() {
        ...
        // 鱼头圆心的坐标 -- 控制点1
        final PointF fishHead = new PointF(ivFish.getX() + fishDrawable.getHeadPoint().x, ivFish.getY() + fishDrawable.getHeadPoint().y);
        // 点击坐标 -- 结束点
        ...
        objectAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                Object x = animation.getAnimatedValue("x");
                Object y = animation.getAnimatedValue("y");
