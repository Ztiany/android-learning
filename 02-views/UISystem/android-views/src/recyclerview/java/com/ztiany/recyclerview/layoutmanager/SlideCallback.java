...
public class SlideCallback extends ItemTouchHelper.SimpleCallback {
    ...
    public SlideCallback(RecyclerView mRv, UniversalAdapter<SlideCardBean> adapter, List<SlideCardBean> mDatas) {
        super(0, 15);
        this.mRv = mRv;
    ...
    public void onSwiped(@NonNull RecyclerView.ViewHolder viewHolder, int direction) {
        SlideCardBean remove = mData.remove(viewHolder.getLayoutPosition());
        mData.add(0, remove);
