package me.ztiany.compose.foundation.animation.practice
...
//https://github.com/compose-museum/sample-app/blob/main/Chapter_06_Animation/FavButtonDemo/app/src/main/java/com/example/compose/favbutton/FavButton.kt
@Composable
fun FavButton() {
