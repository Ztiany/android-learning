...
import com.ztiany.recyclerview.common.adapter.recycler.DiffRecyclerAdapter;
...
public class RecyclerViewFragment extends BaseListFragment {
    ...
    private final DiffUtil.ItemCallback<Person> itemCallback = new DiffUtil.ItemCallback<Person>() {
        @Override
