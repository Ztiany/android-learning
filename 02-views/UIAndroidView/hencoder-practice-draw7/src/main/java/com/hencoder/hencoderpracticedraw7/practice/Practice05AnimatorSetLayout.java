    ...
    protected void onAttachedToWindow() {
        ...
        animateBt.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ObjectAnimator animator4 = ObjectAnimator.ofFloat(view, View.SCALE_X.getName(), 0, 1);
                ObjectAnimator animator5 = ObjectAnimator.ofFloat(view, View.SCALE_Y.getName(), 0, 1);
