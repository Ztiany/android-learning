...
public class Practice13GetTextBoundsView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        paint2.getTextBounds(text1, 0, 1, mRect);
        int rectMiddle = (top + bottom) / 2;
        int middle = rectMiddle - ((mRect.top + mRect.bottom) / 2);
        canvas.drawText(text1, 100, middle, paint2);

        paint2.getTextBounds(text2, 0, 1, mRect);
        middle = rectMiddle - ((mRect.top + mRect.bottom) / 2);
        canvas.drawText(text2, 200, middle, paint2);

        paint2.getTextBounds(text3, 0, 1, mRect);
        middle = rectMiddle - ((mRect.top + mRect.bottom) / 2);
        ...
        paint2.getTextBounds(text5, 0, 1, mRect);
        middle = rectMiddle - ((mRect.top + mRect.bottom) / 2);
        canvas.drawText(text5, 500, middle, paint2);

        paint2.getTextBounds(text6, 0, 1, mRect);
        middle = rectMiddle - ((mRect.top + mRect.bottom) / 2);
