...
public class BitmapMonitor {
    ...
    public static boolean init(Config config) {
        ...
        BitmapFileWatcher.init(
                config.restoreImageDirectory,
                config.clearAllFileWhenRestartApp,
                config.clearFileWhenOutOfThreshold,
                config.diskCacheLimitBytes
        );
    ...
    public static boolean start(CurrentSceneProvider provider) {
        ...
        int ret = hookBitmapNative(
                sConfig.checkRecycleInterval,
                sConfig.getStackThreshold,
                sConfig.restoreImageThreshold,
                sConfig.restoreImageDirectory,
                sConfig.clearFileWhenOutOfThreshold
        );
     ...
     */
    @Keep
    private static native int hookBitmapNative(long checkRecycleInterval, long getStackThreshold, long copyLocalThreshold, String copyDir, boolean clearFileWhenOutOfThreshold);
