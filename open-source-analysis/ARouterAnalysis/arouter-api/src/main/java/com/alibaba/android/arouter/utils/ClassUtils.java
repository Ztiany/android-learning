...
public class ClassUtils {
    ...
    public static List<String> getSourcePaths(Context context) throws PackageManager.NameNotFoundException, IOException {
        ...
        // /data/app/com.alibaba.android.arouter.demo-lNXKoNTJ0YqHmT8shwKCPg==/base.apk
        Log.d(TAG, "getSourcePaths sourceApk = " + sourceApk);
        // /data/user/0/com.alibaba.android.arouter.demo 其实就是  /data/data/com.alibaba.android.arouter.demo
        Log.d(TAG, "getSourcePaths dataDir = " + applicationInfo.dataDir);

        if (!vmMultidexCapable) {

            //the total dex numbers
            int totalDexNumber = getMultiDexPreferences(context).getInt(KEY_DEX_NUMBER, 1);

            ///data/data/com.alibaba.android.arouter.demo/code_cache/secondary-dexes 下找其他的 dex
