    ...
    private File insertInitCodeIntoJarFile(File jarFile) {
        ...
        if (jarFile) {
            ...
            while (enumeration.hasMoreElements()) {
                ...
                /*找到 com/alibaba/android/arouter/core/LogisticsCenter 这个类*/
        ...
        void visitInsn(int opcode) {
            ...
            if ((opcode >= Opcodes.IRETURN && opcode <= Opcodes.RETURN)) {
                extension.classList.each { name ->
                    ...
                    mv.visitMethodInsn(Opcodes.INVOKESTATIC, ScanSetting.GENERATE_TO_CLASS_NAME, ScanSetting.REGISTER_METHOD_NAME, "(Ljava/lang/String;)V", false)
                    //这里生成的代码是类似
                    //LogisticsCenter.register(name)
                    //LogisticsCenter.register(name)
                    //LogisticsCenter.register(name)
                    //LogisticsCenter.register(name)
                }
