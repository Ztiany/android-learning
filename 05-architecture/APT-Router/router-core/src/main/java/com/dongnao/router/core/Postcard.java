...
public class Postcard extends RouteMeta {
    ...
    public Object navigation() {
        return DNRouter.getInstance().navigation(null, this, -1, null);
    }

    public Object navigation(Context context) {
        return DNRouter.getInstance().navigation(context, this, -1, null);
    }
    ...
    public Object navigation(Context context, int requestCode) {
        return DNRouter.getInstance().navigation(context, this, requestCode, null);
    }

    public Object navigation(Context context, int requestCode, NavigationCallback callback) {
        return DNRouter.getInstance().navigation(context, this, requestCode, callback);
    }
