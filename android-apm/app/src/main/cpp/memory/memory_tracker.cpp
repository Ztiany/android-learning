...
extern "C" JNIEXPORT void JNICALL Java_me_ztiany_apm_aspect_memory_MemoryTracker_hookMemoryAllocation(
        JNIEnv *env,
        jobject caller
) {
    hookMemory();
...
extern "C" JNIEXPORT void JNICALL Java_me_ztiany_apm_aspect_memory_MemoryTracker_dumpMemoryAllocationInfo(
        JNIEnv *env,
        jobject caller
) {
