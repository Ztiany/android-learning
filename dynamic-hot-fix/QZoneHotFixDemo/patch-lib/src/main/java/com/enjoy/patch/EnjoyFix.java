...
public class EnjoyFix {
    ...
    public static void installPatch(Application application, File patch) {
        //把补丁 hack.jar 拷贝到内部存储。
        File hackFile = initHack(application);

        //获取应用类加载器，Android 中即 PathClassLoader
        ...
        // Android N混合编译处理，替换掉系统的 ClassLoader，否则将会去加载优化过的镜像文件。
    ...
    private static final class V23 {
        ...
        private static void install(
            ...
            // 从 pathList 找到 makePathElements 方法并执行，然后得到补丁创建的 Element[]
            Object[] objects = makePathElements(dexPathList, new ArrayList<>(additionalClassPathEntries), optimizedDirectory, suppressedExceptions);
        ...
        private static Object[] makePathElements(
            ...
            //通过阅读 android6、7、8、9源码，都存在 makePathElements 方法
            Method makePathElements = ShareReflectUtil.findMethod(
                    dexPathList,
                    "makePathElements",
                    List.class,
                    File.class,
    ...
    private static final class V19 {
        ...
        private static Object[] makeDexElements(
            ...
            Method makeDexElements = ShareReflectUtil.findMethod(
                    dexPathList,
                    "makeDexElements",
                    ArrayList.class,
                    File.class,
