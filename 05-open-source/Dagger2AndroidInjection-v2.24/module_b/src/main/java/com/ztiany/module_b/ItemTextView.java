...
public class ItemTextView extends AppCompatTextView {
    ...
    @Subcomponent()
    public interface CustomTextViewComponent extends ViewComponent<ItemTextView> {

        @Subcomponent.Builder
        interface Builder extends ViewComponentBuilder<ItemTextView, CustomTextViewComponent> {
        }
    }
