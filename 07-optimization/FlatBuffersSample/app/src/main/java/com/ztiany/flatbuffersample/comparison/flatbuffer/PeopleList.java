...
public final class PeopleList extends Table {
  ...
  public static PeopleList getRootAsPeopleList(ByteBuffer _bb, PeopleList obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public void __init(int _i, ByteBuffer _bb) { bb_pos = _i; bb = _bb; }
  public PeopleList __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }

  public People peoples(int j) { return peoples(new People(), j); }
  public People peoples(People obj, int j) { int o = __offset(4); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
